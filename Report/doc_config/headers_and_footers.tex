...
%-----------------------------------------------
	% Headers
	\fancyhead[LO]{\footnotesize\textbf{\textit{Sistemes SATCOM de comunicació a aeronaus}}} % Section mark
	\fancyhead[RO]{\includegraphics[height=35pt]{./doc_config/image}}
	\fancyhead[LE]{\footnotesize\textbf{\textit{Antenes i equips dels sistemes de navegació i comunicació a aeronaus}}}
